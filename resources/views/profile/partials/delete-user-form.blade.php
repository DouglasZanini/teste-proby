<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Uma vez que sua conta seja deletada, todos os seus recursos e dados serão permanentemente excluídos. Antes de excluir sua conta, por favor, baixe quaisquer dados ou informações que deseje manter.') }}
        </p>
    </header>
